...
public class Media implements org.apache.thrift.TBase<Media, Media._Fields>, java.io.Serializable, Cloneable {
  ...
  private List<Person> person; // optional
  ...
  private _Fields optionals[] = {_Fields.TITLE,_Fields.WIDTH,_Fields.HEIGHT,_Fields.FORMAT,_Fields.DURATION,_Fields.SIZE,_Fields.BITRATE,_Fields.PERSON,_Fields.PLAYER,_Fields.COPYRIGHT};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.person = new ArrayList<Person>(_list0.size);
      ...
      if (struct.person != null) {
        if (struct.isSetPerson()) {
          oprot.writeFieldBegin(PERSON_FIELD_DESC);
          {
            ...
            for (Person _iter3 : struct.person)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetPerson()) {
        {
          ...
          for (Person _iter4 : struct.person)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.person = new ArrayList<Person>(_list5.size);
