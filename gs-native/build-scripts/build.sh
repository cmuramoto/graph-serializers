...
function compile(){
    ...
    target="-D__GS__$1__"
    cmd='gcc '$target' -O3 -Wall -Wunused-label -c -msse4.1 -mavx2 -fmessage-length=0 -MMD -MP -MF"Release/com_nc_gs_io_UTF8Util.d" -MT"Release/com_nc_gs_io_UTF8Util.d" -o "Release/com_nc_gs_io_UTF8Util.o" "../com_nc_gs_io_UTF8Util.c"'
    echo $cmd
    eval $cmd
