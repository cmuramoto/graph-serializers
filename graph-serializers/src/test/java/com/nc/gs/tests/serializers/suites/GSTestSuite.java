...
@SuiteClasses({ AssortedTests.class, TestTypeAnnon.class, //
		...
		TestCyclicOptimization.class, TestCompression.class, TestInternedBean.class, //
		TestArrayHolder.class })
