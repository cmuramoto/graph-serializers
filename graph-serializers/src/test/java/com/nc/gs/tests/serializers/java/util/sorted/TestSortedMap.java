...
public class TestSortedMap extends AbstractRoundTripTests {

	static class Holder {

		@com.nc.gs.meta.Map(optimize = true)
		Map<A, String> as;
	...
	class ReverseStatefullComparator implements Comparator<A> {
		...
		public int compare(final A left, final A right) {
			...
			return TestSortedMap.this.compare(left, right);
		}
	}
